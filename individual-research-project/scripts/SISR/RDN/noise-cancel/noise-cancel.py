...
# output_image_files
output_image_files = ['output_image/img_001_SRF_2_RDN_noise-cancel.png', 
                      'output_image/img_002_SRF_2_RDN_noise-cancel.png', 
                      'output_image/img_003_SRF_2_RDN_noise-cancel.png', 
                      'output_image/img_004_SRF_2_RDN_noise-cancel.png', 
                      'output_image/img_005_SRF_2_RDN_noise-cancel.png']
...
if __name__ == "__main__":
    ...
    for i in range(5): # len(input_image_files) / len(output_image_files)
        ...
        logging.info(f"RDN: noise-cancel | Single experiment processing time: {elapsed_time_experiment} seconds")
        # Log the separation line
        logging.info(f"################################################################################################")
    ...
    logging.info(f"RDN: noise-cancel | Total processing time: {elapsed_time_total} seconds")

    # Log the mean processing time
    logging.info(f"RDN: noise-cancel | Mean processing time: {elapsed_time_mean} seconds")

    # Log the separation line
    logging.info(f"################################################################################################")

    # Indication of processing time of RRDN gans model
    print(f"RDN: noise-cancel | Total processing time: {elapsed_time_total} seconds")

    # Indication of mean processing time of RRDN gans model
    print(f"RDN: noise-cancel | Mean processing time: {elapsed_time_mean} seconds")
