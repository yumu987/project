...
# source_image_files
source_image_files = ['source_image/img_001_SRF_4_RRDN_gans.png', 
                      'source_image/img_002_SRF_4_RRDN_gans.png', 
                      'source_image/img_003_SRF_4_RRDN_gans.png', 
                      'source_image/img_004_SRF_4_RRDN_gans.png', 
                      'source_image/img_005_SRF_4_RRDN_gans.png']

# resize_image_files
resize_image_files = ['resize_image/img_001_SRF_4_RRDN_gans_resize.png', 
                      'resize_image/img_002_SRF_4_RRDN_gans_resize.png', 
                      'resize_image/img_003_SRF_4_RRDN_gans_resize.png', 
                      'resize_image/img_004_SRF_4_RRDN_gans_resize.png', 
                      'resize_image/img_005_SRF_4_RRDN_gans_resize.png']

# output_image_files
output_image_files = ['output_image/img_001_SRF_4_RRDN_gans_noise_cancel.png', 
                      'output_image/img_002_SRF_4_RRDN_gans_noise_cancel.png', 
                      'output_image/img_003_SRF_4_RRDN_gans_noise_cancel.png', 
                      'output_image/img_004_SRF_4_RRDN_gans_noise_cancel.png', 
                      'output_image/img_005_SRF_4_RRDN_gans_noise_cancel.png']
...
if __name__ == "__main__":
    ...
    # Load resized RRDN gans images and perform super-resolution
    for i in range(5): # len(resize_image_files) / len(output_image_files)
        ...
        logging.info(f"gans: RDN: noise-cancel | Single experiment processing time: {elapsed_time_experiment} seconds")
        # Log the separation line
        logging.info(f"################################################################################################")
    ...
    logging.info(f"gans: RDN: noise-cancel | Total processing time: {elapsed_time_total} seconds")

    # Log the mean processing time
    logging.info(f"gans: RDN: noise-cancel | Mean processing time: {elapsed_time_mean} seconds")

    # Log the separation line
    logging.info(f"################################################################################################")

    # Indication of processing time of RRDN gans model
    print(f"gans: RDN: noise-cancel | Total processing time: {elapsed_time_total} seconds")

    # Indication of mean processing time of RRDN gans model
    print(f"gans: RDN: noise-cancel | Mean processing time: {elapsed_time_mean} seconds")

    # Indication of super-resolution completed
    print(f"gans: RDN: noise-cancel | Super-resolution completed")
