...
disp('FeatureSIM extra script is executing');
...
% Encoded
x6 = encoded_fsim_array;
y6 = encoded_fsimc_array;
scatter(x6, y6, 50, 'cyan', 'filled');
title('FSIM & FSIMc of Encoded');
xlabel('FSIM');
ylabel('FSIMc');
grid on;
saveas(gcf, 'FSIM_FSIMc_Encoded.png');
% Decoded
x7 = decoded_fsim_array;
y7 = decoded_fsimc_array;
scatter(x7, y7, 50, 'yellow', 'filled');
title('FSIM & FSIMc of Decoded');
xlabel('FSIM');
ylabel('FSIMc');
grid on;
saveas(gcf, 'FSIM_FSIMc_Decoded.png');
%-----------------------------------------------------------------------
...
%-----------------------------------------------------------------------
disp('FeatureSIM extra is completed');
%-----------------------------------------------------------------------
